...
tagline: Test feature toggles without backend changes
section: tools
order: 2
icon: toggle-left
description: Override feature flag states at runtime during development and testing with the Angular Toolbar Feature Flags tool
keywords: ['feature flags', 'angular', 'toolbar', 'testing', 'feature toggles']
---
...
- [Permissions Tool](/ngx-dev-toolbar/docs/permissions/) — Test permission-based access control
- [App Features Tool](/ngx-dev-toolbar/docs/app-features/) — Test product-level features
- [Presets Tool](/ngx-dev-toolbar/docs/presets/) — Save and load flag configurations
