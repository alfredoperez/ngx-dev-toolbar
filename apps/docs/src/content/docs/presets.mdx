---
title: Presets Tool
description: Save and load complete toolbar configurations
---
...
- [Feature Flags Tool](/ngx-dev-toolbar/feature-flags/) — Managed by presets
- [Language Tool](/ngx-dev-toolbar/language/) — Managed by presets
- [Permissions Tool](/ngx-dev-toolbar/permissions/) — Managed by presets
- [App Features Tool](/ngx-dev-toolbar/app-features/) — Managed by presets
