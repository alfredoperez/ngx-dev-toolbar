...
tagline: Test role-based access control without backend changes
section: tools
order: 4
icon: lock
description: Override user permissions at runtime to test different access control scenarios in your Angular application
keywords: ['permissions', 'rbac', 'access control', 'angular', 'toolbar', 'authorization']
---
...
- [Feature Flags Tool](/ngx-dev-toolbar/docs/feature-flags/) — Test feature toggles
- [App Features Tool](/ngx-dev-toolbar/docs/app-features/) — Test product-level features
- [Presets Tool](/ngx-dev-toolbar/docs/presets/) — Save permission configurations
